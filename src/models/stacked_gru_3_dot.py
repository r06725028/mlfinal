...
def gen_model(weights=None):
    ...
    q_gru_3 = Bidirectional(GRU(80, return_sequences=True))(q_gru_2)
    q_avg_pool = GlobalAveragePooling1D()(q_gru_3)
    q_max_pool = GlobalMaxPooling1D()(q_gru_3)
    ...
    a_gru_3 = Bidirectional(GRU(80, return_sequences=True))(a_gru_2)
    a_avg_pool = GlobalAveragePooling1D()(a_gru_3)
    a_max_pool = GlobalMaxPooling1D()(a_gru_3)
